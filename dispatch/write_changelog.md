...
## Trigger — read `~/Projects/dotfiles/docs/DOCUMENTATION_RULES.md`, then `~/Projects/dotfiles/docs/CHANGELOG_VOICE.md`
...
## The voice (summary — `~/Projects/dotfiles/docs/CHANGELOG_VOICE.md` is canonical)
...
- **No marketing words** — use the canonical banned-word lists in
  `~/Projects/dotfiles/docs/CHANGELOG_VOICE.md` and `~/Projects/dotfiles/docs/DOCUMENTATION_RULES.md`; do not duplicate
  either list here.
...
- `~/Projects/dotfiles/docs/CHANGELOG_VOICE.md` — the canonical Mintlify-style voice rules (deep reference).
