...
- **Dimension 7.1** — DONE — a repository carrying its own `AGENTS.md` installs without losing a byte of it; orly's rules land as `AGENTS.orly.md` → Test `install > an existing AGENTS.md survives and orly lands beside it`
